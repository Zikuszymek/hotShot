...
public class ActiveInfo extends Model implements Comparable<ActiveInfo>{
    ...
    public static void AddAllinterestingElement(){
        ...
        ActiveInfo info2 = new ActiveInfo(BuildConfig.VERSION_NAME,date1,"O Aplikacji","W zgiełku pracy i wykonywanych obowiązków ludzie zwykle wykonują kilka " +
                "powtarzalnych  czynności.\nOdbierają mejle, piją kawę, telefonują i obowiązkowo przeglądają gorące oferty z kilku ulubionych stron internetowych." +
                "\nCzemu by nie zaoszczędzić trochę czasu i skorzystać z aplikacji która oprócz tego że będzie prezentować obecne gorące oferty to jeszcze powiadomi nas" +
